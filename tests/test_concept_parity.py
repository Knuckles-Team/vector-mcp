...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/vector-mcp"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in vector-mcp
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in vector-mcp but are NOT registered "
