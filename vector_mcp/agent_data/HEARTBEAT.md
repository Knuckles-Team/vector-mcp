...
5. **Domain-Specific Checks**:
   - **Database Status**: Check vector database connectivity and collection health.
   - **Index Stats**: Report on vector dimensions, index counts, and recent embedding errors.
