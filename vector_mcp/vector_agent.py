...
def usage():
    print(
        f"Vector Mcp ({__version__}): CLI Tool\n\n"
        "Usage:\n"
        ...
        "Examples:\n"
        "  [Simple]  vector-agent \n"
        '  [Complex] vector-agent --host "value" --port "value" --debug "value" --reload --provider "value" --model-id "value" --base-url "value" --api-key "value" --mcp-url "value" --mcp-config "value" --custom-skills-directory "value" --web\n'
    )
