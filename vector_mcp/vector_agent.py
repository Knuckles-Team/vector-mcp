...
def usage():
    print(
        ...
        "Examples:\n"
        "  [Simple]  vector-agent \n"
        '  [Complex] vector-agent --host "value" --port "value" --debug "value" --reload --provider "value" --model-id "value" --base-url "value" --api-key "value" --mcp-url "value" --mcp-config "value" --skills-directory "value" --web\n'
    )
