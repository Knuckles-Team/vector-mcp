...
name: vector-starter
description: >-
  Vector API + MCP Server + A2A Server Use when working with Vector via this package's MCP
...
license: MIT
tags: [vector-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---
...
Starter skill for the **Vector** package. Use the `mcp-client` universal skill
